...
namespace Negocio
{
    public class UsuarioData
    {
        ...
        public void AgregarUsuario(Usuario usuarioActual)
        {
            //Creo el comando para ejecutar la sentencia SQL de DELETE, 
            //le asocio la Conexión también
            SqlCommand cmdInsertarUsuario = new SqlCommand(" INSERT INTO usuarios(nombre_usuario, " +
                                               " clave, hablitado, nombre, apellido, email) " +
                                               " VALUES (@usuario,@clave, @hab, @nombre,@apellido " +
                                               "@email", this.Conn);
